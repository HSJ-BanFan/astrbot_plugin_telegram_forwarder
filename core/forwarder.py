    ...
    def _cleanup_orphaned_files(self):
        ...
        try:
            for filename in os.listdir(self.plugin_data_dir):
                if filename in allowlist or filename.endswith(".session") or filename.endswith(".session-journal") or filename.endswith(".session-shm") or filename.endswith(".session-wal"):
                    continue
